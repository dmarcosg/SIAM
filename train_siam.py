...
from datasets import SUNAttributesDataset, SoNDataset, ToTensor, Rescale, RandomCrop, VerticalFlip, my_collate, Rotate, NetSUNTop, NetSoNTop
...
freeze_sun_net = True
net_folder = 'sun_son'
init_net_name = 'sun_son/last_model_finetuned.pt'
...
if warm_start:
    ...
    if init_net_name[0:8] == 'base_sun':
        ...
        net.load_state_dict(torch.load(os.path.join(init_net_name)))
